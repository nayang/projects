...
//Constructs a new GreenPepper object

public class GreenPepper extends FoodItem {
	/**
	 * This constructor initializes a new GreenPepper item
	 * @param name The name of the GreenPepper, which is passed to the superclass constructor to initialize the FoodItem.
	 */
